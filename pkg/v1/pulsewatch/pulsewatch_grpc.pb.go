...
const (
	PulseWatch_GetPulse_FullMethodName     = "/pulsewatch.v1.PulseWatch/GetPulse"
	PulseWatch_WatchProcess_FullMethodName = "/pulsewatch.v1.PulseWatch/WatchProcess"
)
...
func (UnimplementedPulseWatchServer) WatchProcess(*WatchProcessRequest, grpc.ServerStreamingServer[WatchProcessResponse]) error {
	return status.Error(codes.Unimplemented, "method WatchProcess not implemented")
}
...
func RegisterPulseWatchServer(s grpc.ServiceRegistrar, srv PulseWatchServer) {
	// If the following call panics, it indicates UnimplementedPulseWatchServer was
...
var PulseWatch_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pulsewatch.v1.PulseWatch",
